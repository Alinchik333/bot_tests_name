...
TOKEN = '6777995938:AAFgobxkBMRBAPhaGugwUZTDnRKiJtLCIwg'
...
def message_handler(message: types.Message):
    ...
    if message.text == "1️⃣":
        ...
        bot.send_message(chat_id=message.chat.id, text="срочно хотфикс! говорил я вам, не нужно деплоить в пятницу!!!")
        return
